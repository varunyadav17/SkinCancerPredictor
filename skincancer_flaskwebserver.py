# -*- coding: utf-8 -*-
"""SkinCancer_FlaskWebServer.ipynb
...
logger = logging.getLogger('Skin Cancer Classifier')

UPLOAD_FOLDER = 'D:\Personal\SR\SkinCancerReact\skincancerdiagnosis'
...
def fileUpload():
    ...
    logger.info("Welcome to Skin cancer classifier`")
